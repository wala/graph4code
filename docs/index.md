...
To help better understand the structure of code graphs generated by Graph4Code, we provide here an random sample of each data source of used by Graph4Code: https://github.com/wala/graph4code/tree/master/sample_graph 
